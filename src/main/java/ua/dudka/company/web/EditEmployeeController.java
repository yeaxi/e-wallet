...
public class EditEmployeeController {
    ...
    private String getPathToPage() {
        return "company/edit-employee";
    }

    public static class Links {
        public static final String EDIT_EMPLOYEE_PAGE_URL = "/company/edit-employee/{id}";
        public static final String EDIT_EMPLOYEE_URL = "/company/edit-employee/send";
    }
}